// get user's email to send forgetpassword token
...
export default function ForgetPage() {
  ...
  return (
    <div className="flex w-full min-h-screen items-center justify-center">
      <div className="w-2/5 h-2/5 min-h-[27vh] bg-white rounded shadow flex 
        flex-col px-[2%] py-[1%] justify-around items-center"
        >
