...
function SignUp() {
  ...
  return (
    <div className="flex h-screen justify-center items-center md:p-3">
      <div className="flex flex-col justify-between w-full md:w-3/5 lg:w-2/5 
        h-1/2 mx-[2%] md:mx-0 rounded shadow p-2 bg-gray-100">
        {/* heading  */}
        <div className="text-center h-auto text-3xl font-semibold">SignUp</div>
